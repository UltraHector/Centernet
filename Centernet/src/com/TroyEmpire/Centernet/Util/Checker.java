...
public class Checker {
	...
	/**
	 * can not be called from oncreate <br/>
	 * only be called onresume
	 */
	public void check(Resource... resources) {
		...
		} else if (resourcesList.contains(Resource.NETWORK)
				&& !isWifiOpen(activity)) {
			new AlertDialog.Builder(activity)
		...
		} else if (resourcesList.contains(Resource.BLUETOOTH)
				&& !isBluetoothActivated(activity)) {
			new AlertDialog.Builder(activity)
	...
	// when need to check the wifi is connected use this method
	...
	// when need to check whether the wifi is enabled use this method
